            ...
            <div className="container">
                ...
                <div className="d-flex flex-row order-2 order-lg-3 user_info">
                    <div className="group_btn d-none d-sm-block">
                        <a href="login.html" className="group_link log_in registration">LOG IN</a>
                        <a href="signup.html" className="group_link registration hover">SIGN UP</a>
                    </div>
                    ...
                    <ul className="navbar-nav">
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a className="dropdown-item" href="user-portfolio.html">Admin Panel</a></li>
                            </ul>
                        </li>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="play.html">HOW TO PLAY</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="faq.html">FAQ</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link pd_right" href="contact.html">CONTACT US</a>
                        </li>
                        <li className="nav-item d-block d-sm-none"> 
                            <a className="nav-link registration" href="login.html">LOG IN</a>
                        </li>
                        <li className="nav-item d-block d-sm-none">
                            <a className="nav-link registration hover" href="signup.html">SIGN UP</a>
                        </li>
                    </ul>
                </div>
            </div>
